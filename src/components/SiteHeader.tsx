                                ...
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    {user ? (
                                        ...
                                        <div className="mt-8 flex gap-4">
                                            ...
                                            <a href="https://github.com/RACHIT-KUSHWAHA" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 text-white transition hover:bg-white/10 hover:scale-110">
                                                <Github className="h-5 w-5" />
                                            </a>
                                            <a href="https://beyondrachit.me" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 text-white transition hover:bg-white/10 hover:scale-110">
